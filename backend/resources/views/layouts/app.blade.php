    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-72 bg-gray-900 text-white flex flex-col hidden md:flex">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                @elseif(auth()->user()->role === 'petugas')
                    {{-- MENU PETUGAS --}}
                    <a href="{{ route('petugas.peminjaman.index') }}" class="block px-4 py-2 rounded-lg transition text-sm leading-tight
                    ...
                    <a href="{{ route('petugas.pengembalian.index') }}" class="block px-4 py-2 rounded-lg transition text-sm leading-tight
                    ...
                    <a href="{{ route('petugas.laporan.index') }}" class="block px-4 py-2 rounded-lg transition text-sm leading-tight
                ...
                @else
                    {{-- MENU PEMINJAM --}}
                    <a href="{{ route('peminjam.dashboard') }}" class="block px-4 py-2 rounded-lg transition text-sm leading-tight
                    {{ request()->routeIs('peminjam.dashboard') ? 'bg-gray-800 text-white font-medium shadow' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                        🏠 Dashboard
                    </a>
                    <a href="{{ route('peminjam.katalog') }}" class="block px-4 py-2 rounded-lg transition text-sm leading-tight
                    {{ request()->routeIs('peminjam.katalog') ? 'bg-gray-800 text-white font-medium shadow' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                        📦 Katalog Alat
                    </a>
                    <a href="{{ route('peminjam.riwayat') }}" class="block px-4 py-2 rounded-lg transition text-sm leading-tight
                    {{ request()->routeIs('peminjam.riwayat') ? 'bg-gray-800 text-white font-medium shadow' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                        📋 Riwayat Peminjaman
                    </a>
                @endif
